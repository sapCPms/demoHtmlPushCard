sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/sap/mit/web/products/app", ".html");
		...
		return Opa5.extend("com.sap.mit.web.products.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/sap/mit/web/products/localService/mockserver"], function (mockserver) {
